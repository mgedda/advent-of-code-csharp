...
namespace AdventOfCode.Y2020.Day08
{
    class Solution : Solver
    {
        ...
        {
            int RunProgram(ImmutableArray<Instruction> program, int i, int accumulator, ImmutableHashSet<int> visited)
            {
            ...
            return RunProgram(program, 0, 0, ImmutableHashSet<int>.Empty);
        }
        ...
        int PartTwo(string input)
        {
            ...
            var program = ParseInput(input);
            ImmutableHashSet<ImmutableArray<Instruction>> programs = AlterProgram(program, 0, ImmutableHashSet<ImmutableArray<Instruction>>.Empty);
